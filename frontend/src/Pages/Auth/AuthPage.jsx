...
function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint = activeTab === 'signup' ? 'http://localhost:3000/api/v1/user/signup' : 'http://localhost:3000/api/v1/user/login'
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center p-4 md:p-8">
        <div className="text-white text-center max-w-md">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Welcome to HangoutRoom</h1>
          <p className="text-lg md:text-xl mb-6 md:mb-8">Experience the future of virtual collaboration</p>
